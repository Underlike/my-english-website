 ...
 */
final class Version20210528073418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vocabulary ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE vocabulary ADD CONSTRAINT FK_9099C97BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_9099C97BA76ED395 ON vocabulary (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9099C97BA76ED395 ON vocabulary');
        $this->addSql('ALTER TABLE vocabulary DROP user_id');
    }
}
